...
interface UserTeamDataSource {
    ...
    suspend fun createUserTeams(userId: String, teamId: String, staffLevelId: String, manager: Boolean = true)

    suspend fun updateMember(userTeamId: String, staffLevelId: String, manager: Boolean)
}